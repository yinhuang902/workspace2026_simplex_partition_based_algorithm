    ...
    * if you see verbose, ignore it, it just prints more things...
    ...
    while len(nodes) < target_nodes:
        ...
        with open(dbg_candidates_path, "a", encoding="utf-8") as _dbf:
            ...
            _dbf.write("\n")
        # --- POINT_SELECT_MODE: 1=ms-first, 2=weighted composite (LB-best), 3=weighted avg all ms, 4=avg cs (LB-best) ---
        POINT_SELECT_MODE = 4
        ...
        if chosen_cand is not None:
            ...
            try:
                ...
                if POINT_SELECT_MODE == 4:
                    termination_reason = "mode4_subdivide_failed"
